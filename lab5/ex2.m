...
ci1 = 1/f1 * v1/v2;
ci2 = 1/f2 * v1/v2;
fprintf('The Confidence Level for the ratio of variances: (%3.4f, %3.4f)\n', ci1, ci2);
fprintf('The Confidence Level for the ratio of std. deviations: (%3.4f, %3.4f)\n', sqrt(ci1), sqrt(ci2));
